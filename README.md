...
I worked through the book by hand first, then converted the solutions into
LaTeX where available. This repository keeps both versions because the scans
show the original reasoning, while the typed writeups include corrections and
cleaner derivations from later verification.
...
| 5 | [Scan](sections/section_05/handwritten/section_05_handwritten.pdf) | Not yet transcribed | Not yet compiled | Worked Problems 1-3 |
| 6 | [Scan](sections/section_06/handwritten/section_06_handwritten.pdf) | Not yet transcribed | Not yet compiled | Worked Problems 1-2 |
...
Sections 5 and 6 currently contain scans only. Section 10 is code-first, so
its implementations remain in Kaggle notebooks rather than LaTeX files.
